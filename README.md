...
**Stack:** C# + .NET 10 LTS + WPF (MVVM) · **Player v1:** PotPlayer via `SendMessage` (sem simular teclas) · **Status:** Fase 5 — Lock de monitor (30 testes)
...
- [x] Fase 5 — Monitores (lista real + lock por reposicionamento) (esta versão)
- [ ] Fase 6 — Persistência
- [ ] Fase 7 — Testes
