...
**Stack:** C# + .NET 10 LTS + WPF (MVVM) · **Player v1:** PotPlayer via `SendMessage` (sem simular teclas) · **Status:** Fase 4 — Atalhos contextuais (17 testes)
...
- [x] Fase 4 — Atalhos contextuais + Modo Jogo (esta versão)
